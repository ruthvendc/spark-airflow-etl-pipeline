...
input_file_path = os.path.join(directory_path, "raw", "maint_costs_raw.csv")
output_file_path = os.path.join(directory_path, "bronze", "maint_costs")

spark = SparkSession.builder.appName("IngestMaintCosts").getOrCreate()
